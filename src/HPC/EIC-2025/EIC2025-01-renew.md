...
EICへの接続にあたり [自動二段階接続](./EIC2025-0A-two-step-connection.md) を行うなど，`~/.ssh/config` ファイルに接続の設定が記述されている人は，そこに以下のような記述があるはずです．
...
ユーザー名が変わってしまったため，以前のEICでMiniforgeによる環境を構築していた人は，インストールのやりなおしが必要です．
