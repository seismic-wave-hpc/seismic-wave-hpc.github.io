...
abstract: 地震波動伝播の数値シミュレーション技術の普及のためのオンライン講習会を開催します．講習会は初級編と中級編の2部構成で，初級編では差分法による数値シミュレーションの基本概念を基礎から学びます．中級編はオープンソースの地震波動伝播数値シミュレーションソフトウェア[OpenSWPC](https://openswpc.github.io) を体験し，活用するためのより実践的な講習会です．
---
...
- Linuxなどにおけるコマンドライン操作の経験があることが望ましいですが，必須ではありません．講習会中で説明しながら進めます．
- 解説するソフトウェアはFortranで記述されています．ただし，この講習会の内容に限ればFortranの利用経験は必要ではありません．
...
初級編・中級編とも，申し込みは [こちら](https://forms.gle/DCciKgMZofssBg1aA) のFormからお願いします．
