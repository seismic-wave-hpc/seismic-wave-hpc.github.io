...
abstract: 地震波動伝播の数値シミュレーション技術の普及のためのオンライン講習会を開催します．今年度は初級編（2025/10/30）と中級編（2025/11/13）の二本立てで実施します．前者では，基礎から差分法による数値シミュレーションの基本概念を学びます．後者はオープンソースの地震波動伝播数値シミュレーションソフトウェア[OpenSWPC](https://openswpc.github.io) を活用するためのより実践的な講習会です．【本ページで紹介している講習会は終了しました】
---
...
- 実習および実演は，東京大学地震研究所附属日本列島モニタリング研究センターが提供する[計算機システム](https://eic-support.eri.u-tokyo.ac.jp)を用いて行います．実演にはどなたでもご参加いただけますが，実習に参加するためには講習会当日までに同計算機システムのアカウントをご準備ください．アカウントの申し込み方法は上記公式ページのほか，当ウェブの[こちら](/HPC/EIC-2025/EIC2025-02-new.md)にも解説があります．
...
::::
<<<<<<< HEAD:src/FDM-Workshop/workshop-2025.md
=======

### 参加申し込み

参加受付は締め切りました．
>>>>>>> 051bec7389ff724ff1f4c063c67803ec0bbdcafa:src/FDM-Workshop/fdm-workshop.md
